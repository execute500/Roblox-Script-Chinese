...
if not ExecutorSupport then print("[mspaint] 加载停止，请使用mspaint的官方loadstring(错误:ExecutorSupport == nil)") return end
if getgenv().mspaint_loaded then print("[mspaint] 加载停止(错误:已加载)") return end
