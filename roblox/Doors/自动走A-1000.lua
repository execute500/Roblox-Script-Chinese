...
if game.PlaceId ~= 6839171747 or game.ReplicatedStorage.GameData.Floor.Value ~= "Rooms" then
	game.StarterGui:SetCore("SendNotification", { Title = "无效位置"; Text = "检测到的游戏似乎不是rooms,请在rooms内执行此操作!" })
...
elseif workspace:FindFirstChild("PathFindPartsFolder") then
	game.StarterGui:SetCore("SendNotification", { Title = "警告"; Text = "如果您遇到问题并且机器人已损坏,请联系我!" })
...
LatestRoom:GetPropertyChangedSignal("Value"):Connect(function()
    ...
    if LatestRoom.Value ~= 1000 then
        ...
        game.StarterGui:SetCore("SendNotification", { Title = "youtube.com/geoduude"; Text = "谢谢你使用我的脚本!" })
        return
    end
end)
